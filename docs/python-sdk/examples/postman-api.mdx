...
- [Tools →](/basics/tools) - Learn about REST API tools
- [RESTAPIToolkit API →](/python-sdk/api-reference/tools#restapitoolkit) - API reference
- [WebSocket Demo →](/python-sdk/examples/websocket-demo) - Similar example

## Related

- [REST API Tools →](/basics/tools/rest-api-tools) - REST API tools guide
- [RESTAPIToolkit API →](/python-sdk/api-reference/tools#restapitoolkit) - Complete API reference
