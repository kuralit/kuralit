...
- [Add Tools →](/python-sdk/examples/simple-tools) - Add custom Python functions as tools
- [Voice Assistant →](/python-sdk/examples/voice-assistant) - Complete example with multiple toolkits
- [Tools →](/basics/tools) - Learn about adding capabilities
