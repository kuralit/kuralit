...
- [Protocol Reference →](/protocol) - Complete WebSocket protocol documentation
- [Quickstart →](/getting-started/quickstart) - Connect your existing API to an AI Voice Agent
- [Server Examples →](/python-sdk/examples/minimal-server) - Test with different servers

## Related

- [Protocol →](/protocol) - WebSocket protocol reference
- [Voice →](/basics/voice) - Real-time voice streaming
- [Quickstart →](/getting-started/quickstart) - Connect your existing API to an AI Voice Agent
