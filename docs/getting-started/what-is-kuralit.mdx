...
<Card
  title="Quickstart: Connect AI Voice Agent to Mobile App"
  icon="rocket"
  href="/getting-started/quickstart"
>
  Complete guide: Python server + Flutter mobile app
</Card>
...
1. **[Quickstart →](/getting-started/quickstart)** - Connect AI Voice Agent to mobile app in 10 minutes
